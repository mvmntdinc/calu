...
const translations = {
  pt: {
    ...
    'hero.title': 'Pare de depender<br/><em>de indicação.</em>',
    'hero.sub': 'Ajudamos profissionais liberais a conquistar clientes com duas estratégias: ser descoberto nas redes sociais e ser encontrado no Google.',
    'hero.btn1': 'Solicitar diagnóstico gratuito →',
    ...
    'services.title': 'Autoridade Digital ou Busca Inteligente.',
    'services.sub': 'Antes de qualquer proposta, fazemos um diagnóstico gratuito para descobrir qual estratégia — ou combinação — faz mais sentido para o seu momento.',
    'service1.name': '🎥 Autoridade Digital',
    'service1.desc': 'Vídeo profissional no seu consultório, presença estratégica no Instagram e campanhas no Meta Ads. Para quem precisa gerar demanda e construir autoridade nas redes.',
    'service2.name': '🔎 Busca Inteligente',
    'service2.desc': 'Google Ads, Google Maps otimizado e landing pages de alta conversão. Para captar clientes que já estão procurando o seu serviço no Google agora mesmo.',
    'service3.name': 'Quero fortalecer meu Instagram',
    'service3.desc': 'Produção de vídeos profissionais, roteiro estratégico e gestão de redes. Transformamos seu perfil em um canal ativo de aquisição de clientes.',
    'service4.name': 'Quero aparecer no Google',
    'service4.desc': 'Google Ads, SEO e otimização do Perfil da Empresa. Apareça no momento certo, para o cliente certo — com alta probabilidade de conversão.',
  ...
  en: {
    ...
    'hero.title': 'Stop relying<br/><em>on referrals.</em>',
    'hero.sub': 'We help independent professionals win clients with two strategies: being discovered on social media and being found on Google.',
    'hero.btn1': 'Request a free diagnosis →',
    ...
    'services.title': 'Digital Authority or Smart Search.',
    'services.sub': 'Before any proposal, we run a free diagnosis to find which strategy — or combination — makes the most sense for your moment.',
    'service1.name': '🎥 Digital Authority',
    'service1.desc': 'Professional video at your clinic, strategic Instagram presence and Meta Ads campaigns. For those who need to generate demand and build authority on social media.',
    'service2.name': '🔎 Smart Search',
    'service2.desc': 'Google Ads, optimized Google Maps and high-conversion landing pages. To capture clients who are already searching for your service on Google right now.',
    'service3.name': 'Strengthen my Instagram',
    'service3.desc': 'Professional video production, strategic scripting and social media management. We turn your profile into an active client acquisition channel.',
    'service4.name': 'Appear on Google',
    'service4.desc': 'Google Ads, SEO and Business Profile optimization. Show up at the right moment, for the right client — with high conversion probability.',
